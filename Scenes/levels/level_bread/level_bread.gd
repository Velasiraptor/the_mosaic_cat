...
var full_tile := 30 # кол-во игровых клеток
...
func cat_good_combo_1():
	...
	start_combo(cats_combo_1, 2, 1, 1, 1, randi_range(2, 4), 1, randi_range(1, 2), \
	randi_range(1, 2))
...
func cat_good_combo_2():
	...
	start_combo(cats_combo_2, 1, 1, 2, randi_range(1, 2), randi_range(2, 4), \
	1, 2, randi_range(1, 2))
...
func cat_good_combo_3():
	...
	start_combo(cats_combo_3, randi_range(1, 2), 4, randi_range(1, 2), 2, \
	randi_range(2, 4), randi_range(1, 2), 1, randi_range(1, 2))
...
func cat_good_combo_4():
	...
	start_combo(cats_combo_4, randi_range(1, 2), randi_range(1, 2), 2, 1, \
	randi_range(2, 4), 2, 2, randi_range(1, 2))
...
func cat_good_combo_5():
	...
	start_combo(cats_combo_5, 1, 2, randi_range(1, 2), 1, randi_range(6, 7), \
	randi_range(1, 2), 1, 1)
...
func cat_good_combo_6():
	...
	start_combo(cats_combo_6, randi_range(1, 2), 1, 4, 1, randi_range(2, 3), randi_range(1, 2), 1, \
	randi_range(1, 2))
...
func cat_good_combo_7():
	...
	start_combo(cats_combo_7, 1, 1, 1, randi_range(1, 2), randi_range(2, 4), \
	1, 1, 2)
