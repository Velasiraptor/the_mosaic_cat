...
var full_tile := 47 # кол-во игровых клеток
...
func cat_good_combo_1():
	...
	start_combo(cats_combo_1, randi_range(1, 3), 1, randi_range(1, 3), 4, 7, \
	3, randi_range(1, 3), 2)
...
func cat_good_combo_2():
	...
	start_combo(cats_combo_2, 3, randi_range(1, 3), 2, 1, 7, \
	randi_range(1, 3), 2, 1)
...
func cat_good_combo_3():
	...
	start_combo(cats_combo_3, randi_range(1, 3), 1, randi_range(1, 3), 1, 3, \
	4, 2, 2)
...
func cat_good_combo_4():
	...
	start_combo(cats_combo_4, 2, 3, 2, 2, 3, \
	randi_range(1, 3), 1, randi_range(1, 3))
...
func cat_good_combo_5():
	...
	start_combo(cats_combo_5, 1, 2, randi_range(1, 3), 1, 3, \
	3, randi_range(1, 3), 4)
...
func cat_good_combo_6():
	...
	start_combo(cats_combo_6, 1, randi_range(1, 3), 2, randi_range(1, 3), 7, \
	1, 4, 1)
...
func cat_good_combo_7():
	...
	start_combo(cats_combo_7, 1, randi_range(1, 3), 3, 2, 3, \
	2, randi_range(1, 3), 2)
