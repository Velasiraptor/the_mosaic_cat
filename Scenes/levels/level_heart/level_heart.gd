...
func cat_good_combo_1():
	...
	start_combo(cats_combo_1, 4, randi_range(1, 2), 3, 2, randi_range(5, 6), \
	randi_range(1, 2), 3, 2)
...
func cat_good_combo_2():
	...
	start_combo(cats_combo_2, randi_range(1, 2), 5, 3, randi_range(1, 2), randi_range(5, 6), \
	3, 2, randi_range(1, 2))
...
func cat_good_combo_3():
	...
	start_combo(cats_combo_3, 2, 4, randi_range(2, 3), 3, randi_range(5, 6), \
	2, randi_range(1, 2), 2)
...
func cat_good_combo_4():
	...
	start_combo(cats_combo_4, randi_range(1, 2), 2, 2, 4, randi_range(5, 6), \
	3, 2, 2)
...
func cat_good_combo_5():
	...
	start_combo(cats_combo_5, randi_range(1, 2), randi_range(2, 3), 2, 2, randi_range(1, 3), \
	5, 3, 2)
...
func cat_good_combo_6():
	...
	start_combo(cats_combo_6, randi_range(1, 2), 2, 3, randi_range(2, 3), randi_range(1, 3), \
	2, 2, 5)
...
func cat_good_combo_7():
	...
	start_combo(cats_combo_7, 2, 2, randi_range(1, 2), 2, randi_range(5, 6), \
	randi_range(1, 2), 5, 3)
