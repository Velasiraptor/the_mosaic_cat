...
var full_tile := 26 # кол-во игровых клеток
...
func cat_good_combo_1():
	...
	start_combo(cats_combo_1, 1, 1, randi_range(1, 2), 1, 6, \
	1, 1, randi_range(1, 2))
...
func cat_good_combo_2():
	...
	start_combo(cats_combo_2, randi_range(1, 2), 2, 1, 1, 6, \
	randi_range(1, 2), randi_range(1, 2), 1)
...
func cat_good_combo_3():
	...
	start_combo(cats_combo_3, randi_range(1, 2), randi_range(1, 2), 1, 2, 6, \
...
func cat_good_combo_4():
	...
	start_combo(cats_combo_4, 2, randi_range(1, 2), randi_range(1, 2), randi_range(1, 2), 6, \
	2, randi_range(1, 2), randi_range(1, 2))
...
func cat_good_combo_5():
	...
	start_combo(cats_combo_5, randi_range(1, 2), randi_range(1, 2), randi_range(1, 2), 4, 2, \
	1, randi_range(1, 2), 1)
...
func cat_good_combo_6():
	...
	start_combo(cats_combo_6, randi_range(1, 2), 2, 2, randi_range(1, 2), 6, \
	randi_range(1, 2), 1, randi_range(1, 2))
...
func cat_good_combo_7():
	...
	start_combo(cats_combo_7, 1, randi_range(1, 2), randi_range(1, 2), randi_range(1, 2), 6, \
	3, randi_range(1, 2), 1)
