...
var full_tile := 42 # кол-во игровых клеток
...
func cat_good_combo_1():
	...
	start_combo(cats_combo_1, 3, 2, 2, 1, 6, \
	randi_range(1, 3), randi_range(1, 3), 1)
...
func cat_good_combo_2():
	...
	start_combo(cats_combo_2, 1, randi_range(1, 3), 1, 1, 6, \
	2, 3, randi_range(1, 3))
...
func cat_good_combo_3():
	...
	start_combo(cats_combo_3, 1, 5, randi_range(1, 3), 1, randi_range(2, 3), \
	2, randi_range(1, 2), 1)
...
func cat_good_combo_4():
	...
	start_combo(cats_combo_4, 1, randi_range(1, 3), 4, 1, 6, \
	randi_range(1, 3), 1, 1)
...
func cat_good_combo_5():
	...
	start_combo(cats_combo_5, 2, 2, 1, 3, 6, \
	randi_range(1, 3), randi_range(1, 3), 1)
...
func cat_good_combo_6():
	...
	start_combo(cats_combo_6, 1, 1, 1, 2, randi_range(2, 3), \
	3, randi_range(1, 3), 2)
...
func cat_good_combo_7():
	...
	start_combo(cats_combo_7, randi_range(1, 3), 1, randi_range(1, 3), randi_range(1, 3), 6, \
	1, 4, 3)
